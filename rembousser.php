...
<body>
	<p><div class="dep">VOUS VOULEZ REMBOURSER EN PARTIE OU TOTALEMENT VOS EMPRIENTS</div></p>
<p align="center"><font size="14px">entrez les champs ci-dessous et validez OK</center></font></p>
<center>
<div class="direct">
<form name="form" method="POST" action="effectrem.php" target="blank">
	 <label>Nom :</label><br>
	  ...
	  <label>Montant à rembourser :</label><br>
	  <input type="number" name="kap"  id="kap" required><br><br>
	  <input type='submit' value='OK!!!' id='envoyer' name='retrait'>
    <p>NB: Vous pouvez rembousser en tranche ou totalement du coup sa depend de vous mais soyez dans les delaits<br>
